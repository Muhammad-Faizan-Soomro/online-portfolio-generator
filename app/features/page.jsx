...
function page() {
  return (
    <>
      <Navbar />
      <h1 className="text-3xl  lg:text-5xl text-center font-bold text-orange-400 mt-4">
        WHAT WE WILL OFFER?
      </h1>
      <div className="features  w-screen h-screen  flex flex-col lg:flex-row lg:justify-evenly items-center gap-10 mt-20 ">
        <div className="features w-[300px] h-full  flex flex-col border-0 border-black">
          <Image src={f1} />
        <h1 className="text-center text-2xl font-bold">Easy To Use</h1>
          <p className="text-justify font-bold text-blue-900 mt-2">
        ...
        <div className="features w-[350px] h-full  flex flex-col border-0 border-black">
          <Image src={f2} />
