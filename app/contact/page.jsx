  ...
  return (
    ...
    <Navbar/>
      ...
      <section className="hidden lg:flex  w-full h-full">
        <div className="img w-[50%]  h-screen flex flex-col" >
          <div className="image w-[100%] h-full">
            <Image src={Contact} width={400}  className='ml-60'/>
          </div>
          <div className="links w-[100%] h-full flex flex-col items-center ">
            <h1 className="text-3xl font-bold  text-orange-400 underline">TEAM MEMBERS:</h1>
            <div className="names">
          <ol className="text-2xl font-bold flex flex-col gap-4 mt-2 ml-4">
       ...
       <div className="form w-[50%]  h-screen flex flex-col gap-3 items-center justify-center">
        <h1 className="text-3xl font-bold pb-10">HAVE SOME QUESTIONS?</h1>
          ...
          >
            <input type="text" className="w-[400px] h-10    border-2 border-orange-400" placeholder="Enter Your First Name" />   
            <input type="text" className="w-[400px] h-10    border-2 border-orange-400" placeholder="Enter Your Last Name" />          
            <input type="email" className="w-[400px] h-10    border-2 border-orange-400" placeholder="Enter Your  Email" />          
            <textarea name="message" id="2" cols="50" rows="50"  className="w-[400px] h-10    border-2 border-orange-400" placeholder="Enter Your Message"></textarea>
         <button className="py-3 w-[400px] rounded-lg text-white font-bold bg-orange-400">Submit</button>
          </form>
        </div>
